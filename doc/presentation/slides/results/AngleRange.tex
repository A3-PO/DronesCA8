...
\begin{frame}{Results}{Scenario 1 - Angle Range}
  ...
  \begin{figure}[H]
    \centerline{
    \subfigure[P Controller]{
    \includegraphics[scale=0.25]{figures/s1_p_power1.png}}
    \subfigure[PD Controller]{
    \includegraphics[scale=0.25]{figures/s1_pd_power1.png}}}
    \centerline{
    \subfigure[PI Controller]{
    \includegraphics[scale=0.25]{figures/s1_pi_power1.png}}
    \subfigure[PID Controller]{
    \includegraphics[scale=0.25]{figures/s1_pid_power1.png}}}
  \end{figure}
