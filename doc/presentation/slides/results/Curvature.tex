...
\begin{frame}{Results}{Scenario 2 - Curvature of the Earth}
  ...
  \begin{figure}[H]
    \centerline{
    \subfigure[UAS Map]{
    \includegraphics[scale=0.25]{figures/s2_zoom1.png}}
    \hfill
...
\begin{frame}{Results}{Scenario 2 - Curvature of the Earth}
  ...
  \begin{figure}[H]
    \centerline{
    \subfigure[UAS Map]{
    \includegraphics[scale=0.25]{figures/s2_zoom2.png}}
    \hfill
...
\begin{frame}{Results}{Scenario 2 - Curvature of the Earth}
  ...
  \begin{figure}[H]
    \centerline{
    \subfigure[UAS Map]{
    \includegraphics[scale=0.25]{figures/s2_zoom3.png}}
    \hfill
...
\begin{frame}{Results}{Scenario 2 - Curvature of the Earth}
  ...
  \begin{figure}[H]
    \centerline{
    \subfigure[UAS Map]{
    \includegraphics[scale=0.25]{figures/s2_zoom4.png}}
    \hfill
