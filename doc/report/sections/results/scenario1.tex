...
\begin{figure}[H]
\hfill
\subfigure[.]{\includegraphics[scale=0.45]{figures/s1_topographic_map.png}}
\hfill
\subfigure[caption]{\includegraphics[scale=0.45]{figures/s1_pd_los_distance.eps}}
\hfill
\caption{caption}
...
%\begin{figure}[H]
%\hfill
%\subfigure[.]{\includegraphics[scale=0.4]{figures/s1_pd_drone_theta_phi_optimal.eps}}
%\hfill
%\subfigure[caption]{\includegraphics[scale=0.4]{figures/s1_pd_gs_theta_phi_optimal.eps}}
%\hfill
%\caption{caption}
%\label{fig:sinc}
%\end{figure}
