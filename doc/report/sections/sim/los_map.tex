...
\begin{figure}[H]
  ...
  \includegraphics[scale=0.3]{figures/dk_map.png}
  \label{fig:before_map}}
  \hfill
  \subfigure[GS and UA Placement]{
  \includegraphics[scale=0.3]{figures/gs_ua_map.png}
...
\begin{figure}[H]
  ...
  \includegraphics[scale=0.31]{figures/los_area.png}
  \label{fig:los_area}}
  \hfill
  \subfigure[Zoom of LOS Area]{
  \includegraphics[scale=0.33]{figures/zoom_los_map.png}
  \label{fig:zoom_map}}
  \hfill
