...
Therefore, it is essential to keep the first Fresnel zone clear of obstruction when planning wireless links. However, it is hard to avoid 100$\%$ of the obstructions in the real-life. Thus, at least 60 $\%$ of the signal should be clear of obstructions. However, to get optimum performance it is recommended to have the obstructed signal less than 20$\%$ \cite{proxim}\cite{fresnelWiki}.
...
In the last example, the GS and UA antennas are kept at the same heights as in the previous examples, but the distance between them is 50km.
...
\begin{align*}
\text{r} = 8.657\cdot \sqrt{\frac{D}{f}} = 8.657\cdot \sqrt{\frac{50}{2.4}} = 39.5m \approx 40m 
\end{align*}
