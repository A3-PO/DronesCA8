...
Lest try to find out how tall a structure could be at the center of the Fresnel Zone, if 60\% should be clear of this zone, i.e 40\% should be blocked. Lets assume as on figure \ref{fig:fresnel_zones_10km_height} that both antennas are at a height of 20 meters. Here the first Fresnel zone would pass just 2.3 meters above ground level in the middle of the link. 
