...
%draw a vector from origin to point (P) 
    ...
    \shade[shading=ball, ball color=green] (P) circle (.3mm) node[above right] {$Drone$};
...
%draw phi arc and label, using rotated coordinate system
    \tdplotdrawarc[tdplot_rotated_coords]{(0,0,0)}{0.2}{\phivec}{90}{anchor=west}{$\phi$}

\shade[shading=ball, ball color=blue] (0,0,0) circle (.3mm);
