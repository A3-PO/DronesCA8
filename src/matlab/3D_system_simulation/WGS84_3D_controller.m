...
%% Initial values
% Drone position
% lat_init_d = 57.10231686;
% lat_end_d = 57.10940214;
% long_init_d = 9.86263275;
% long_end_d = 10.10295868;
lat_init_d = 56.08736247;
lat_end_d = 56.15166933;
long_init_d = 8.26781273;
long_end_d = 10.20492554;

lat_drone = lat_init_d:(lat_end_d-lat_init_d)/prec_geo:lat_end_d;        % The position X of the DRONE
long_drone = long_init_d:(long_end_d - long_init_d)/prec_geo:long_end_d;   % The position Y of the DRONE
alt_drone = 100*ones(1,length(lat_drone));                                 % The position Z of the DRONE
